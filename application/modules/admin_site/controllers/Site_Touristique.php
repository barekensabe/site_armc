...
class Site_Touristique extends CI_Controller
{


    public function index(){

     $this->load->view('Site_Touristique_View');
 }
...

    {
        ...
        $data_array=array("TITRE_SITE"=>$this->input->post('TITRE_SITE'),"DESC_SITE"=>$this->input->post('DESC_SITE'),"TITRE_SITE_ENG"=>$this->input->post('TITRE_SITE_ENG'),"DESC_SITE_ENG"=>$this->input->post('DESC_SITE_ENG'),"IMAGE_SITE"=>$image);
  ...
  # code...
        ...
        $rep_doc =FCPATH.'uploads/image_site/';
        $code=date("YmdHis");
